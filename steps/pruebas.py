...
def asignar(context):
    try:
        ...
        context.driver.get("C:\\Users\\Ariel\\OneDrive\\Documentos\\QUINTOSEMESTRE\\Requisitos\\Maquetados\\Chofer\\Chofer.html")
...
@when('Busca Chofer a Visualizar {nombre}')
def escogerChofer(context,nombre):
    try:
        select_element = context.driver.find_element(By.XPATH, '//*[@id="nombre"]')
        select_element.send_keys(nombre)  # Seleccionar por texto visible
        take_screenshot(context, '2. Buscar Chofer a Visualizar')
